...
DUTY_CYCLE_SLOPE = 200          # Change in PWM duty cycle integer in MCU for each V/m change in E Field
...
EFIELD_MAX_POTENTIAL = 5        # nominal value of electric field at 100% pwm duty cycle
